        ...
        if($count > 0) {
            ...
            while($row = mysqli_fetch_assoc($query)) {
                ...
                $orders[] = [
                    ...
                    'status' => $row['status'],
                    'actions' => '<button type="button" class="delivered-button btn btn-success btn-xs" data-toggle="tooltip" data-placement="top" title="Mark Status as Delivered" data-id="' . $orderID . '"><span class="fas fa-check fa-fw"></span></button>'
                ];
            }
