...
<body>
    ...
    <div class="mainbody">
        ...
        <div class="content">
            <div class="title">Registered Clients Report</div>
            ...
            <table class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th width="25%">Date & Time Registered</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                        ...
                        $query = mysqli_query($connection, "SELECT * FROM `accounts`
                            ...
                            WHERE `accounts`.`created_at` LIKE '$todayStamp%'");
...
<?php
    ...
    $dompdf->render();
    $dompdf->stream($today . '_registered_clients_report.pdf', [
        'Attachment' => false
    ]);
