...
<nav class="navbar navbar-default navbar-static-top no-margin">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <div class="navbar-brand"><span class="fas fa-hand-holding-usd fa-fw"></span> Cash Flow Statement</div>
        </div>
...
<div id="page-wrapper-content">
    <div class="row">
        <div class="col-sm-4">
            <h3 class="page-header">Generate Cash Flow Statement</h3>
...
?>
<script src="../js/custom/factory_management/cash_flow_statement.js"></script>
<?php
