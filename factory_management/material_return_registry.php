...
<nav class="navbar navbar-default navbar-static-top no-margin">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <div class="navbar-brand"><span class="fas fa-undo fa-fw"></span> Material Return Registry</div>
        </div>
...
<script src="../js/custom/factory_management/material_return_registry.js"></script>
<?php
