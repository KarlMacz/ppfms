    ...
    <div class="sidebar">
        <div class="sidebar-nav navbar-collapse">
            ...
            <ul class="nav">
                ...
                <li><a href="supplier_enlistment.php"><span class="fas fa-plus fa-fw"></span> Supplier Enlistment</a></li>
            </ul>
            <div class="nav-label">:: Order Management ::</div>
            <ul class="nav">
                <li><a href="order_processing.php"><span class="fas fa-th-list fa-fw"></span> Order Processing</a></li>
